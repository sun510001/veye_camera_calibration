...
###
 ...
 # @LastEditTime: 2024-06-10 20:05:12
 # @FilePath: /camera/codes/camera_test/write_camera.sh
 # @Description: 
 # 
...
# sleep .2 && \
# ./veye_mipi_i2c.sh -w -f new_mshutter -p1 12000 -b 4 && \
# sleep .2 && \
# ./veye_mipi_i2c.sh -w -f new_mgain -p1 6.0 -b 4 && \
# sleep .2 && \
...
# sleep .2 && \
# ./veye_mipi_i2c.sh -w -f new_mshutter -p1 12000 -b 6 && \
# sleep .2 && \
# ./veye_mipi_i2c.sh -w -f new_mgain -p1 6.0 -b 6 && \
# sleep .2 && \
